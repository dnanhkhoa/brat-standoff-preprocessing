...
class MultipleEvaluator(object):
    ...
    def track2(self, corpora, tag_type=None, mode='strict', verbose=False):
        ...
        #     'Cancer', 'Cell', 'Organism', 'DNA_domain_or_region', 'Simple_chemical', 'Multi-tissue_structure', 'Organ',
        #     'Organism_subdivision', 'Tissue', 'Immaterial_anatomical_entity', 'Organism_substance',
        ...
        # )
        #
        # # Add entity types here to exclude
        # self.exclude_tags = (
        ...
        elif corpora.corpus_type == 'id11_tr':
            self.tags = (
                "Chemical",
                "Entity",
                "Organism",
...
if __name__ == '__main__':
    ...
    parser.add_argument('--corpus-type', dest='corpus_type', type=str, required=True,
